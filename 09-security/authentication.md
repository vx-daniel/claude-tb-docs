...
| Setting | Description |
|---------|-------------|
| minVerificationCodeSendPeriod | Minimum seconds between code sends |
| verificationCodeCheckRateLimit | Max verification attempts (e.g., "5:300") |
| maxVerificationFailuresBeforeUserLockout | Failures before account lock |
