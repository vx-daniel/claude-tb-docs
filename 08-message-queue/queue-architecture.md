...
| Topic | Purpose | Default Partitions |
|-------|---------|-------------------|
| `tb_core` | Core platform messages | 10 |
| `tb_core.notifications` | Direct core service notifications | 1 per service |
| `tb_rule_engine` | Rule engine processing | Configurable |
| `tb_rule_engine.notifications` | Direct rule engine notifications | 1 per service |
| `tb_transport.notifications` | Transport service notifications | 1 per service |
| `tb_edge` | Edge device synchronization | 10 |
| `tb_edge.notifications` | Edge service notifications | 1 per service |
| `tb_usage_stats` | Usage statistics collection | 1 |
| `tb_ota_package` | OTA update distribution | 1 |
| `tb_housekeeper` | Cleanup and maintenance tasks | 1 |
| `tb_housekeeper.reprocessing` | Failed task reprocessing | 1 |
| `tb_version_control` | Version control operations | 10 |
| `tb_cf_event` | Calculated field events | Configurable |
| `tb_cf_state` | Calculated field state | Configurable |
