...
| Service Type | Identifier | Description |
|--------------|------------|-------------|
...
|---------|---------|---------|
| VC Executor | Git operations, version control | Low volume, 1-2 instances |
| Entity Query (EDQS) | Optimized entity data queries | Scale with query load |
| Task Processor | Background jobs, cleanup | Scale with job queue |
