...
The message carries a stack of calling contexts:
- Chain ID and Node ID that initiated the call
- Enables proper callback routing in nested scenarios
- Stack unwound as sub-chains complete
